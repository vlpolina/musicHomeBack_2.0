"""
Django settings for musicHome project.
...
SECRET_KEY = 'django-insecure-zgwrk5f00zvf#g8ozh@jt^=asf)sik1nchb1+riq+r&x)w=w25'
...
WSGI_APPLICATION = 'musicHome.wsgi.application'
